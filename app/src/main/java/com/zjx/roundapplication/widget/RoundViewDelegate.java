...
import com.zjx.roundapplication.R;
...
public class RoundViewDelegate {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        backgroundColorFrom = ta.getColor(R.styleable.RoundTextView_rv_backgroundColorFrom, Color.TRANSPARENT);
        backgroundColorTo = ta.getColor(R.styleable.RoundTextView_rv_backgroundColorTo, Color.TRANSPARENT);
        ...
        isGradient = (backgroundColorTo != backgroundColorFrom);
        ta.recycle();
    }

    public void setBackgroundColor(int backgroundColor) {
        this.backgroundColor = backgroundColor;
        this.backgroundColorFrom = Integer.MAX_VALUE;
        this.backgroundColorTo = Integer.MAX_VALUE;
        isGradient = false;
        setBgSelector();
    }

    public void setGradientColor(int colorFrom, int colorTo) {
        this.backgroundColorFrom = colorFrom;
        this.backgroundColorTo = colorTo;
        isGradient = true;
...
//            gd.setColor(color);
            ...
            gd.setColors(new int[]{backgroundColorFrom, backgroundColorTo});
        }
